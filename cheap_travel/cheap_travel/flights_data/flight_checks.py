...
class FlightChecker(object):
    ...
    def check_connection_in_the_beginning(self, origin, dest, depart_date, return_date, connection):
        ...
        if price1 and price2 and price3 :
            return ("Connection in beginning in {} at {}".format(connection, self.pricer.get_departure_flight_date(trip_data2)), price1 + price2 + price3, [trip_data1, trip_data2, trip_data3] )
        else:
            return None
    ...
    def check_connection_in_the_end(self, origin, dest, depart_date, return_date, connection):
        ...
        if price1 and price2 and price3 :
            return ("Connection in the end in {} at {}".format(connection, self.pricer.get_departure_flight_date(trip_data2)), price1 + price2 + price3, [trip_data1, trip_data2, trip_data3] )
        else:
            return None
    ...
    def check_two_connections_stay_in_the_beginning(self, origin, dest, depart_date, return_date, connection):
        ...
        if price1 and price2 :
            return ("Two Connections stay in the beginning in {} at {}".format(connection, self.pricer.get_departure_flight_date(trip_data2)), price1 + price2, [trip_data1, trip_data2]  )
        else:
            return None
    ...
    def check_two_connections_stay_in_the_end(self, origin, dest, depart_date, return_date, connection):
        ...
        price1, trip_data1 = self.pricer.get_price_round_trip(origin, connection, self.self._create_str_date(depart_date), depart_dates)
        ...
        if price1 and price2 :
            return ("Two Connections stay in the end in {} at {}".format(connection, self.pricer.get_return_flight_date(trip_data1)), price1 + price2,[trip_data1, trip_data2] )
        else:
            return None
